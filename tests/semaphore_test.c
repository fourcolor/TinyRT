...
static trt_handle_t sem_test;
static trt_handle_t sem_lock_test;
static trt_handle_t sem_timeout_only;
static trt_handle_t sem_timeout_signal;
...
void app_main(void)
{
    sem_test = trt_sem_create(1, 0);
    sem_lock_test = trt_sem_create(1, 0);
    sem_timeout_only = trt_sem_create(1, 0);
    sem_timeout_signal = trt_sem_create(1, 0);
